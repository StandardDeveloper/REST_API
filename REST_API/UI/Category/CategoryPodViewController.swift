//
//  CategoryPodViewController.swift
//  REST_API
//
//  Created by 이민욱 on 2021/06/11.
//

import UIKit

class CategoryPodViewController: UIViewController {
    ...
    //        case 1:
    //            if(indexPath.row == 1) {
    //                let vegetableVC = self.storyboard?.instantiateViewController(identifier: "vegetableVC") as! MainCategoryViewController
